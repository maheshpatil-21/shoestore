...
const MOCK_PRODUCTS = [
  ...
  { id: 12, name: 'FlexFlow Trainer',    category: 'Training',   price: 94.99,  original_price: 119.99, image: 'https://rxnsports.in/cdn/shop/files/RXN_Mens_Cross_Trainer_Barefoot_Minimalist_Shoe_Zero_Drop_Sole_Training_Shoes_-_TRN-1_6.jpg?v=1726393657&width=1445', rating: 4.5, review_count: 93,  badge: 'Sale',        stock: 20, description: 'Versatile cross-trainer built for HIIT, weights and studio classes. Wide toe box and non-slip outsole.' },
];
